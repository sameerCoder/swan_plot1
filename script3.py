...
def plot():
    ...
    finalplot = pn.Column( tiles * rasterize(hmap1).options(**opts) .opts(hooks=[absolute_position],
                                                                                            apply_ranges=False))
    from bokeh.embed import components
    from bokeh.resources import CDN
